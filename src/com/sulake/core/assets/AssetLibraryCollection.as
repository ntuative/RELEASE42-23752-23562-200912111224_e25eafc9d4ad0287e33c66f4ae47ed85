package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1045:LoaderContext;
      
      protected var var_44:Array;
      
      protected var var_495:Array;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_44 = new Array();
         var_495 = new Array();
         var_1045 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_353 = new AssetLibrary("lib-" + var_584++);
         var_44.push(var_353);
      }
      ...
      public function unload() : void
      {
         while(false)
         {
            (var_495.pop() as IAssetLibrary).dispose();
         }
         while(false)
         {
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         {
            _loc4_ = 0;
            while(_loc4_ < var_495.length)
            {
               _loc3_ = var_495[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  var_495.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
