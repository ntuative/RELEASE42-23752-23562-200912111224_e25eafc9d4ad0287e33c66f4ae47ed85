package com.sulake.core.utils
{
   ...
   public class ZipLoader extends LibraryLoader
   {
      ...
      private var var_530:FZip;
      
      private var var_1160:Array;
      
      private var var_1848:uint = 0;
      ...
      private function onLoaderComplete(param1:Event) : void
      {
         ...
         var_1160.push(var_1.contentLoaderInfo.applicationDomain.getDefinition(_loc3_));
         ++var_779;
         if(var_1160.length == var_1848)
         {
         ...
         {
            var_1.loadBytes(var_530.getFileAt(var_779).content);
         }
      }
      ...
      override public function load(param1:URLRequest, param2:LoaderContext = null, param3:int = 1) : void
      {
         var_308 = param1;
         var_530 = new FZip();
         var_530.addEventListener(Event.COMPLETE,onComplete);
         var_530.addEventListener(IOErrorEvent.IO_ERROR,onIOError);
         var_530.addEventListener(ProgressEvent.PROGRESS,onProgress);
         var_530.load(var_308);
      }
