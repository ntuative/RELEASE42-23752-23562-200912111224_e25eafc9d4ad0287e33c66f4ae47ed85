package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1361:uint = 2;
      
      protected static const const_1359:uint = 1;
      
      protected static const const_1363:int = 5;
      
      protected static const const_1096:uint = 7;
      
      protected static const const_1360:uint = 4;
      
      protected static const const_1362:uint = 3;
       
      
      protected var var_869:int;
      
      protected var var_2176:String = "";
      
      protected var var_354:int;
      
      protected var var_447:XML;
      
      protected var var_1295:Boolean = false;
      ...
      protected var var_308:URLRequest;
      ...
      {
         var_2175 = param1;
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,var_354));
      }
      ...
      protected function prepareLibrary() : void
      {
         ...
         if(var_319 == null)
         {
            failure("Failed to find resource class \"" + _name + "\" in library " + var_308.url + "!");
            return;
         }
         try
         {
         ...
         var_447 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(var_877)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,var_354));
         }
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               debug("Load event STATUS " + var_354 + " for file \"" + var_1.contentLoaderInfo.url + "\"");
               break;
            case Event.UNLOAD:
               debug("Load event UNLOAD for file \"" + var_1.contentLoaderInfo.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,var_354));
               break;
            case ProgressEvent.PROGRESS:
               debug("Load event PROGRESS for file \"" + var_1.contentLoaderInfo.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,var_354));
               break;
            case IOErrorEvent.IO_ERROR:
               failure("IO Error, send or load operation failed for file \"" + var_1.contentLoaderInfo.url + "\"");
               if(!handleHttpStatus(var_354))
               {
         ...
         if(var_418 == LibraryLoader.const_1362)
         {
            if(analyzeLibrary())
            {
               var_418 |= 0;
         ...
         if(var_418 == LibraryLoader.const_1096)
         {
            var_1295 = true;
            prepareLibrary();
            removeEventListeners();
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,var_354));
         }
      }
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_869 > 0)
            {
               var_1.close();
               var_1.unload();
               addRequestCounterToUrlRequest(var_308,const_1363 - var_869);
               var_1.load(var_308,_context);
               --var_869;
               return true;
            }
