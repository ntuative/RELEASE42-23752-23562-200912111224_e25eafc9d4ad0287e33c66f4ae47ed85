package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_865:uint = 4;
      ...
      protected var var_1769:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_864 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_864);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1043 & const_865)
         {
            if(_loc3_ == 0)
            {
