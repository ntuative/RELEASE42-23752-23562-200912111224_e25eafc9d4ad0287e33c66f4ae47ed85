package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IChildEntity, IGraphicContextHost
   {
         ...
         if(_loc9_)
         {
            ...
            if(param2)
            {
               ...
               while(_loc3_ < _loc10_)
               {
                  ...
                  _loc13_ = param1.testParamFlag(WindowParam.const_75);
                  if(_loc13_)
                  {
                     param1.setParamFlag(WindowParam.const_75,false);
                  }
                  param1.offset(-_loc4_,-_loc5_);
                  if(_loc13_)
                  {
                     param1.setParamFlag(WindowParam.const_75,true);
                  }
                  _loc3_++;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_128,WindowParam.const_145);
         var _loc2_:* = !testParamFlag(WindowParam.const_103,WindowParam.const_140);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_22.clone();
            if(_loc1_)
         ...
         else if(testParamFlag(WindowParam.const_75))
         {
            _loc3_ = var_22.clone();
            if(var_23 != null)
            {
      ...
      {
         if(_state == WindowState.const_420)
         {
            return true;
         }
      ...
      public function method_1() : IGraphicContext
      {
         var _loc1_:* = 0;
         var _loc2_:int = 0;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2154 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_344:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_676:
               _loc2_ = "null";
               break;
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_30)
         {
            var_30 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_542,var_22);
            var_30.visible = var_323;
         }
         return var_30;
      }
      ...
      {
         var_379 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_22,WindowRedrawFlag.const_858);
      }
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_868;
                  if(testParamFlag(WindowParam.const_278))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                  ...
                  if((var_29 & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_239))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_239))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_248:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_404,this,null));
                     if(testParamFlag(WindowParam.const_161,WindowParam.const_145))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_155,WindowParam.const_140))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_23 != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_413))
                        {
                           var_23.height += 0 - 0;
                        }
                        var_29 = _loc8_;
                  ...
                  break;
               case WindowNotifyEvent.const_358:
                  _context.invalidate(this,var_22.union(var_60),WindowRedrawFlag.const_448);
                  if(param1 == this)
                  {
               ...
               case WindowNotifyEvent.const_324:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_676,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_195,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_368:
                  _context.invalidate(this,var_22,WindowRedrawFlag.const_995);
                  break;
               case WindowNotifyEvent.const_457:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_344:
                  if(!(var_29 & 0))
                  {
                     ...
                     {
                        method_1();
                        _context.invalidate(this,var_22,WindowRedrawFlag.const_448);
                     }
                  }
                  else if(var_29 & 0)
                  {
               ...
               case WindowNotifyEvent.const_195:
                  ...
                  break;
               case WindowNotifyEvent.const_404:
                  var_23.getRegionProperties(null,var_303);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_281:
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         if(_children.removeChild(_loc2_) != null)
         {
            ...
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_694,this,param1));
            return param1;
         }
         return null;
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_394)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_466)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         }
         if(testParamFlag(WindowParam.const_75))
         {
            if(var_23 != null)
            {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_978,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_647,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_248,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1226,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_62,true);
         _loc1_.type = WindowNotifyEvent.const_1243;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_309 && var_499 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_22.width && param1.y <= var_22.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1512,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1512,param3,param1)) : false;
            }
         }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_23 != param1)
         {
            ...
            if(var_23 != null)
            {
               var_303 = var_23.rectangle.clone();
               var_60.x = var_22.x;
               var_60.y = var_22.y;
               var_60.width = var_22.width;
               var_60.height = var_22.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_445,this,var_23));
            }
            else
            {
               var_303.x = 0;
               ...
               var_303.width = 0;
               var_303.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_816,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,var_239,_type,var_86,var_29,_context,var_22,null,var_583,properties,var_578.concat(),_id) as WindowController;
         _loc2_.var_499 = var_499;
         _loc2_.var_309 = var_309;
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1248,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_551;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_859,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
