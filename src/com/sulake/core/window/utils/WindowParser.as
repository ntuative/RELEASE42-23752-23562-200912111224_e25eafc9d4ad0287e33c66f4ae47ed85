package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1476:String = "_INCLUDE";
      
      public static const const_980:String = "_EXCLUDE";
      
      public static const const_1440:String = "_TEMP";
      
      private static const const_1092:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1093:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1305:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1306:Dictionary;
      
      protected var var_1048:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1048,var_1047);
         var_875 = new Dictionary();
         var_1306 = new Dictionary();
         ParamCodeTable.fillTables(var_875,var_1306);
         var_1305 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1093,"");
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1048)
            {
               delete var_1048[_loc1_];
            }
            for(_loc1_ in var_1047)
            {
               delete var_1047[_loc1_];
            }
            for(_loc1_ in var_875)
            {
               delete var_875[_loc1_];
            }
            for(_loc1_ in var_1306)
            {
               delete var_1306[_loc1_];
            }
            var_1305.dispose();
            var_1305 = null;
            _context = null;
