package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1013:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(var_1320,var_1555);
         var_1061 = new Dictionary();
         var_1554 = new Dictionary();
         StateCodeTable.fillTables(var_1061,var_1554);
         var_425 = new Dictionary();
         var_425["skin"] = BitmapSkinRenderer;
         var_425["bitmap"] = BitmapDataRenderer;
         var_425["fill"] = FillSkinRenderer;
         var_425["text"] = TextSkinRenderer;
         var_425["shape"] = ShapeSkinRenderer;
         var_425["unknown"] = SkinRenderer;
         var_425["null"] = NullSkinRenderer;
         if(var_357 == null)
         {
            var_357 = new Array();
            var_357.push(WindowState.const_62);
            var_357.push(WindowState.const_63);
            var_357.push(WindowState.const_90);
            var_357.push(WindowState.const_47);
            var_357.push(WindowState.const_74);
            var_357.push(WindowState.const_70);
            var_357.push(WindowState.const_85);
            var_357.push(WindowState.const_82);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1061)
         {
            _loc3_.push(var_1061[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1320[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_504[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_504[param1] = new Array(SkinContainer.const_1013);
         }
         var_504[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_504[_loc1_]).dispose();
