package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_776:uint = 256;
      
      protected static var var_584:uint = 0;
      
      protected static var var_358:uint = 0;
      
      public static const const_938:uint = 2;
      
      public static const const_1441:uint = 128;
      
      public static const const_1469:uint = 64;
      
      public static const const_616:uint = 4;
      
      public static const const_1267:uint = 0;
      
      public static const const_1256:uint = 16;
      
      public static const const_542:uint = 1;
      
      public static const const_1205:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_580:Boolean;
      
      protected var var_1519:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1205:
               ...
               break;
            case GraphicContext.const_1256:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_616:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_776:
               break;
            case GraphicContext.const_1267:
               break;
            default:
         ...
         if(var_580)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1519,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1519,16777215);
                  }
                  var_358 += bitmap.width * bitmap.height * 4;
               }
