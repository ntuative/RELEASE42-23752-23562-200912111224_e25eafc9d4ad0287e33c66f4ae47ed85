package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1104:String = "_CONTENT";
      
      private static const const_1106:String = "_HEADER";
      
      private static const const_1105:String = "_SCALER";
      ...
      private var var_1277:IHeaderWindow;
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_239);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_215);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_216);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1277 == null)
         {
            var_1277 = findChildByTag(const_1106) as IHeaderWindow;
            if(!var_1277)
            {
      ...
      {
         return findChildByTag(const_1105) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1295 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_34 == null)
         {
            var_34 = findChildByTag(const_1104) as IWindowContainer;
            if(!var_34)
            {
