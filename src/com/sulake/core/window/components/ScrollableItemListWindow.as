package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_329:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_329)
         {
            var_329 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_329)
            {
               var_329.addEventListener(WindowEvent.const_231,scrollBarEventProc);
               var_329.addEventListener(WindowEvent.const_192,scrollBarEventProc);
            }
         }
         return var_329;
      }
      ...
      override public function dispose() : void
      {
         if(var_329)
         {
            var_329.removeEventListener(WindowEvent.const_231,scrollBarEventProc);
            var_329.removeEventListener(WindowEvent.const_192,scrollBarEventProc);
            var_329 = null;
         }
         if(_cachedItemList)
         {
