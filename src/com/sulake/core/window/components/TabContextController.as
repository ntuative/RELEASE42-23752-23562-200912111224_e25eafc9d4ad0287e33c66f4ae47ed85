package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_876:ITabSelectorWindow;
      
      private var _initialized:Boolean = false;
      
      protected var var_1524:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1524 == null)
         {
            var_1524 = findChildByTag(TabContextController.TAB_CONTEXT_CONTENT_TAG) as IWindowContainer;
         }
         return var_1524;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_876 == null)
         {
            var_876 = findChildByTag(TabContextController.TAB_CONTEXT_SELECTOR_TAG) as ITabSelectorWindow;
            if(var_876 != null)
            {
               var_876.procedure = selectorEventProc;
            }
         }
         return var_876;
      }
