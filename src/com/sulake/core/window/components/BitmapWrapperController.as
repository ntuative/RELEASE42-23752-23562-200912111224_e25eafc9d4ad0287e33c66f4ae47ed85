package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("handle_bitmap_disposing",var_416,PropertyStruct.const_59,var_416 != true));
         _loc1_.push(new PropertyStruct("bitmap_asset_name",var_1041,PropertyStruct.const_204,var_1041 != null));
         return _loc1_;
      }
