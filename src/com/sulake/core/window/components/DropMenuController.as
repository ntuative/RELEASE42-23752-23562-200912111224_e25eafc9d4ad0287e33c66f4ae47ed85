package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private var var_145:DropMenuController;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(var_145 == null || false)
         {
            var_145 = context.create(name + "::submenu","",WindowType.const_461,var_86,0 | 0,_loc1_,subMenuEventProc,null,0,null,["_EXCLUDE"]) as DropMenuController;
         }
         else
         {
            var_145.setGlobalRectangle(_loc1_);
         }
         var_145.activate();
         return var_145;
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_944)
         {
            if(param2 == var_145)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_458,var_86,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         if(var_485 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_485).setStateFlag(WindowState.const_47,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_569)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_484,getSubMenu(),subMenuEventProc);
                  var_569 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_403,this,null,true);
         update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_485 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_297,this,null));
         }
      }
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            if(var_145 != null)
            {
               _loc2_ = var_145.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_569 = false;
            getTitleText().text = var_485 < var_484.length && var_485 > -1 ? "null" : caption;
         }
      }
   }
}
