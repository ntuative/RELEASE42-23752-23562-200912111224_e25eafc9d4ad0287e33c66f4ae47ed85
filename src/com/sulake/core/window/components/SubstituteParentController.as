package com.sulake.core.window.components
{
   ...
   public class SubstituteParentController extends WindowController
   {
      ...
      override public function method_1() : IGraphicContext
      {
         return null;
      }
      ...
      override public function removeChild(param1:IWindow) : IWindow
      {
         ...
         {
            _loc2_.removeEventListener(WindowEvent.const_83,childParamUpdated);
            _loc2_.parent = null;
            return param1;
         }
         return null;
      ...
      override public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         _loc3_.addEventListener(WindowEvent.const_83,childParamUpdated);
         return param1;
      }
