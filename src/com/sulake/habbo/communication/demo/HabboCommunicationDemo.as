package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1846:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1400:ILogger;
      
      private var var_1158:String;
      
      private var var_1845:String;
      
      private const const_1370:String = "fuselogin";
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_300:
               ...
               break;
            case DisconnectReasonEvent.const_934:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_942:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1847)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_636 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_636);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1158,var_1845));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1370,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_462.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_462.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1846);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1370,"/");
      ...
      {
         var_636 = _habboConfiguration.getKey("sso.ticket",null);
         var_1158 = _habboConfiguration.getKey("flash.client.url","");
         var_1845 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_168 == null)
         {
         ...
         if(var_636 != null)
         {
            var_75.mode = HabboConnectionType.const_369;
            var_75.initConnection(HabboConnectionType.const_256);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1400 = param2 as ILogger;
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1846 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_75.mode)
         {
            case HabboConnectionType.const_369:
               _loc6_ = "";
               ...
               var_962 = _loc4_;
               var_168.loadBannerImage(_loc7_ + "?token=" + var_962,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1340:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1343:
               var_960 = generateRandomHexString(30);
               var_462 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_462.init(var_960);
               _loc8_ = var_462.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_962);
         ...
         var_462 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_960 = generateRandomHexString(30);
            var_462.init(var_960);
            _loc12_ = var_462.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_9,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_33.events.addEventListener(RoomSessionEvent.const_99,onRoomSessionEnded);
      }
