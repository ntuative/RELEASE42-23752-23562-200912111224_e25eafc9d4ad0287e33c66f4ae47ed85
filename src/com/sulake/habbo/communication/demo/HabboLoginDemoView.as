package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_663:String = "InitConnection";
      ...
      private var var_321:HabboCommunicationDemo;
      ...
      {
         var_321.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_321.shockwaveClientUrl = var_115.shockwaveClientUrl;
         var_321.ssoTicket = var_115.ticket;
         var_115.removeEventListener(SSOTicket.const_304,onParsedTicketSuccess);
         var_115.removeEventListener(SSOTicket.const_222,onParsedTicketFailure);
         var_115 = null;
         dispatchEvent(new Event(const_663));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1370,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_321 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_321.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_322,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_321.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1370,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_321.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_321.habboCommunication.habboWebLogin(name,password);
         var_115 = new SSOTicket(var_321.assets,_loc2_,_loc1_);
         var_115.addEventListener(SSOTicket.const_304,onParsedTicketSuccess);
         var_115.addEventListener(SSOTicket.const_222,onParsedTicketFailure);
      }
