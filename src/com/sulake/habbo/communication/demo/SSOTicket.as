package com.sulake.habbo.communication.demo
{
   ...
   public class SSOTicket extends EventDispatcher
   {
      ...
      private var var_1228:IHabboWebLogin;
      ...
      public function SSOTicket(param1:IAssetLibrary, param2:IHabboWebLogin, param3:String)
      {
         ...
         _assets = param1;
         var_1228 = param2;
         var_1227 = "http://" + param3 + "/client";
         var_1228.init();
         var_1228.addEventListener(HabboWeb.const_189,requestClientURL);
      }
      ...
      {
         var _loc2_:String = var_1227;
         if(_assets.hasAsset(_loc2_))
         {
            Logger.log("[CoreLocalizationManager] reload localization for url: " + var_1227);
         }
         var _loc3_:URLRequest = new URLRequest(var_1227);
         if(_assets.hasAsset(_loc2_))
         {
      ...
      private function clientURLComplete(param1:Event = null) : void
      {
         ...
         {
            var_1228.requestReAuthenticate();
         }
         else
         {
            try
            {
               var_1452 = /\"sso.ticket\" : \"(.*?)\"/.exec(data)[1];
               var_2017 = /\"flash.client.url\" : \"(.*?)\"/.exec(data)[1];
               if(false)
               {
