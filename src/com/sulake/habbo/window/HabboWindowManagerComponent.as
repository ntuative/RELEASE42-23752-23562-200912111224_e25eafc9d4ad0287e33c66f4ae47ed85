package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1019:uint = 1;
      ...
      private var var_1067:IEventDispatcher;
      
      private var var_2261:uint = 0;
      
      private var var_1069:ProfilerAgentTask;
      
      private var var_1068:ProfilerOutput;
      
      private var var_596:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         {
            var_193 = CoreComponent(param1).root.stage;
            _instance = this;
            var_1067 = Component(param1).events;
            var_717 = new Array();
      ...
      {
         return var_278[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_278[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_596 = new WindowRenderer(_loc4_);
         var_278 = new Array(const_334);
         var _loc6_:int = 0;
         while(_loc6_ < const_334)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_596,this,_localization,var_193,new Rectangle(0,0,var_193.stageWidth,var_193.stageHeight),this);
            var_278[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_393 = var_278[const_1019];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_393.getMouseCursor().defineCustomCursorType(MouseCursorType.const_302,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_393.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1150,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_278[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_278.pop()).dispose();
            }
            if(var_1068 != null)
            {
               var_1068.dispose();
      ...
      {
         return var_278[param1].getDesktopWindow().getChildAt(var_393.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1068 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1068 = new ProfilerOutput(_loc3_,this,var_596);
               var_1066 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1066);
               var_1069 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1069);
               var_888 = true;
            }
         }
      }
      ...
      {
         return var_393.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1067.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_334 - 1;
            while(_loc2_ >= 0)
            {
               var_278[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_888)
         ...
         var_1067.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_334)
         {
            var_278[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_888)
         {
         ...
         var_1067.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_717[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_717[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_393.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1331,new Date().getTime().toString());
            ...
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1157,param2.name + ": " + param2.toString());
            }
         }
      }
   }
