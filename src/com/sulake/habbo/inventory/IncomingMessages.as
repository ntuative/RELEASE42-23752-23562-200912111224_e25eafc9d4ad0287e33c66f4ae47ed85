package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      private function onPetRemoved(param1:PetRemovedFromInventoryEvent) : void
      {
         ...
         var _loc3_:PetsModel = var_27.petsModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function onFurniListRemove(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FurniModel = var_27.furniModel;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_27.setInventoryCategoryInit(InventoryCategory.const_69,false);
      }
      ...
      {
         var _loc2_:EffectsModel = var_27.effectsModel;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_27.notifyChangedEffects();
      }
      
      private function onTradingAccepted(param1:IMessageEvent) : void
      {
         var _loc2_:TradingModel = var_27.tradingModel;
         if(_loc2_ != null)
         {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_27.setInventoryCategoryInit(InventoryCategory.const_701);
         _loc2_.refreshViews();
         var_27.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         var _loc11_:FurniModel = var_27.furniModel;
         if(_loc11_ == null)
         {
            return;
         }
         ...
         var _loc12_:TradingModel = var_27.tradingModel;
         if(_loc12_ != null)
         {
      ...
      public function onClubStatus(param1:IMessageEvent) : void
      {
         ...
         {
            var_27.setClubStatus(_loc2_.periodsSubscribedAhead,_loc2_.daysToPeriodEnd,_loc2_.hasEverBeenMember);
            var_27.events.dispatchEvent(new HabboInventoryHabboClubEvent());
         }
      }
      ...
      public function onAchievementReceived(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:BadgesModel = var_27.badgesModel;
         if(_loc3_ != null)
         {
            _loc3_.updateBadge(_loc2_.badgeID,false);
            _loc3_.removeBadge(_loc2_.removedBadgeID);
         }
         var _loc4_:AchievementsModel = var_27.achievementsModel;
         if(_loc4_ != null)
         {
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_27.setInventoryCategoryInit(InventoryCategory.const_171);
      }
      ...
      public function onUserBadges(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.userId != var_27.sessionData.userId)
         {
            return;
         }
         var _loc3_:BadgesModel = var_27.badgesModel;
      ...
      {
         var_27.creditBalance = (param1 as CreditBalanceEvent).getParser().balance;
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_27.setInventoryCategoryInit(InventoryCategory.const_295);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_27.setInventoryCategoryInit(InventoryCategory.const_69);
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:ISessionDataManager = var_27.sessionData;
         var _loc3_:IRoomSession = var_27.roomSession;
         if(_loc3_ == null)
         {
            return;
         }
         var_27.toggleInventorySubPage(InventorySubCategory.const_241);
         ...
         var _loc11_:TradingModel = var_27.tradingModel;
         if(_loc11_ != null)
         {
      ...
      {
         var _loc2_:PetsModel = var_27.petsModel;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_27.setInventoryCategoryInit(InventoryCategory.const_227);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var _loc3_:MarketplaceModel = var_27.marketplaceModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var_27.pixelBalance = (param1 as HabboActivityPointNotificationMessageEvent).amount;
      }
