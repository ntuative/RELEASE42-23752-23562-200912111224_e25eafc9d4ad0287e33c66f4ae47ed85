package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_1009:MarketplaceModel;
      
      private var var_483:Map;
      
      private var var_482:String;
      
      private const const_1600:int = 2;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_483 = new Map();
         var_483.add(FurniModel.const_41,new FurniGridView(var_91,FurniModel.const_41,_windowManager,_assetLibrary,_roomEngine));
         var_483.add(FurniModel.const_42,new FurniGridView(var_91,FurniModel.const_42,_windowManager,_assetLibrary,_roomEngine));
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = var_483.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_483.getValue(var_482);
         if(_loc4_ != null)
         {
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = var_483.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = var_91.getGroupItemInIndex(_loc3_,var_482);
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_1009 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
      ...
      {
         var _loc3_:FurniGridView = var_483.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
