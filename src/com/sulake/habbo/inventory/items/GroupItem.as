package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2182:BitmapData;
      ...
      protected var var_356:BitmapData;
      
      private const const_1386:Number = 0.2;
      
      protected var var_1304:Boolean;
      
      private const const_1387:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_494)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         if(var_2183 == FurniModel.const_41)
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this);
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1302);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _window.blend = const_1387;
               _loc1_.blend = const_1387;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1304 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2182;
               _loc5_.visible = true;
            }
            else
            {
