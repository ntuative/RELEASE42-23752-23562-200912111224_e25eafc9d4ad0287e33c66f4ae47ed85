package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      public function showMakeOffer(param1:IItem) : void
      {
         ...
         var_2138 = _localization.getKey("roomItem.name." + param1.type);
      ...
      {
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",var_2138);
      ...
      private function checkPrice() : void
      {
         ...
         else if(_loc2_ > var_91.offerMaxPrice)
         {
            _loc6_.text = "${inventory.marketplace.make_offer.max_price}";
            _loc5_.disable();
         }
         else
         {
