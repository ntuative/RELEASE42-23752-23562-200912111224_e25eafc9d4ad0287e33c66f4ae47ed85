package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1573:int = 500;
      ...
      private var var_1316:IncomingMessages;
      ...
      override public function dispose() : void
      {
         ...
         if(var_33 != null)
         {
            ...
            var_33.events.removeEventListener(RoomSessionEvent.const_99,roomSessionEventHandler);
            var_33.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_396,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_99:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_396:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_52.getValue(InventoryCategory.const_701));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_52.getValue(InventoryCategory.const_69));
      }
      ...
      {
         return PetsModel(var_52.getValue(InventoryCategory.const_171));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1573);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_52.getValue(InventoryCategory.const_295));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_724.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_724.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_52.getValue(InventorySubCategory.const_241));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_555 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_724.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_52.getValue(InventoryCategory.const_502) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1316 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_52.getValue(InventoryCategory.const_227));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_33.events.addEventListener(RoomSessionEvent.const_99,roomSessionEventHandler);
         var_33.events.addEventListener(RoomSessionPropertyUpdateEvent.const_396,roomSessionEventHandler);
         ...
         var_52.add(InventoryCategory.const_502,_loc3_);
         ...
         var_52.add(InventoryCategory.const_69,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_555);
         var_52.add(InventoryCategory.const_227,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_52.add(InventoryCategory.const_701,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_555);
         var_52.add(InventoryCategory.const_295,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_52.add(InventorySubCategory.const_241,_loc8_);
         ...
         var_52.add(InventoryCategory.const_171,_loc10_);
