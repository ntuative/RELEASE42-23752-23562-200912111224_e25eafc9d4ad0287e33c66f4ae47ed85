package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, ICoreUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1009:String = "badges";
      
      private static const const_1008:String = "pixelbalance";
      
      private static const const_1010:String = "credits";
      
      private static const const_1006:String = "inventory";
      
      private static const const_1005:String = "friendlist";
      
      private static const const_1011:String = "selectfurni";
      
      private static const const_1007:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_501:ParkBusDialogManager;
      
      private var var_1050:IHabboToolbar;
      ...
      private var var_360:HabboNotificationViewManager;
      ...
      private var var_187:HabboAlertDialogManager;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_707);
         }
         var _loc6_:Map = var_707["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1286);
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_904)
         {
            return;
         }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_187 == null)
         {
            return;
         }
         var_187.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_187.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_187.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1292);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1535)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_993);
            var_1535 = true;
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1052.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_910,_loc5_);
         }
      }
      ...
      {
         if(param1 != null && this.var_360 != null)
         {
            var_360.replaceIcon(param1);
         }
      }
      ...
      {
         if(var_360.isSpaceAvailable() && false)
         {
            var_360.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_501 == null)
         {
            var_501 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_501 != null)
         {
            var_501.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_880.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1052.createPetImage(_loc2_.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_555);
      }
      
      public function onBroadcastAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_156 || param2.type == WindowEvent.const_606)
         {
            param1.dispose();
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               if(_loc15_.productType == CatalogPageMessageProductData.const_88)
               {
                  _loc16_ = var_555.getFloorItemData(_loc15_.furniClassId);
               }
               else if(_loc15_.productType == CatalogPageMessageProductData.const_79)
               {
                  _loc16_ = var_555.getWallItemData(_loc15_.furniClassId);
               }
               _loc7_ = var_555.getProductData(_loc4_.localizationId);
               switch(_loc15_.productType)
               {
                  ...
                  case CatalogPageMessageProductData.const_79:
                     ...
                     else
                     {
                        switch(_loc18_)
                        {
                           case FurniCategory.const_311:
                              _loc17_ = (var_27 as Component).assets.getAssetByName("icon_wallpaper_png") as BitmapDataAsset;
                              if(_loc17_ != null)
                              {
                           ...
                           case FurniCategory.const_317:
                              _loc17_ = (var_27 as Component).assets.getAssetByName("icon_landscape_png") as BitmapDataAsset;
                              if(_loc17_ != null)
                              {
                                 _loc5_ = (_loc17_.content as BitmapData).clone();
                              }
                           ...
                           case FurniCategory.const_320:
                              _loc17_ = (var_27 as Component).assets.getAssetByName("icon_floor_png") as BitmapDataAsset;
                              if(_loc17_ != null)
                              {
                                 _loc5_ = (_loc17_.content as BitmapData).clone();
                              }
                     ...
                     break;
                  case CatalogPageMessageProductData.const_249:
                     _loc17_ = (var_27 as Component).assets.getAssetByName("fx_icon_" + _loc15_.furniClassId + "_png") as BitmapDataAsset;
                     if(_loc17_ != null)
                     {
                        _loc5_ = (_loc17_.content as BitmapData).clone();
                     }
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_993,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1052.createAvatarImage(param2,AvatarScaleType.const_50);
         if(_loc7_ != null)
         {
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         var_187.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      {
         var_1050 = IHabboToolbar(param2);
         var_1050.events.addEventListener(HabboToolbarEvent.const_81,onHabboToolbarEvent);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_184);
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_187 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_555.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_788);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_788);
            }
         }
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_187.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_81)
         {
            ...
            var_360 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_707["styles"],var_707["view"],var_1050);
            ...
            registerUpdateReceiver(var_360,1);
            registerUpdateReceiver(this,2);
            var_555.events.addEventListener(BadgeImageReadyEvent.const_105,onBadgeImage);
            var_1050.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
