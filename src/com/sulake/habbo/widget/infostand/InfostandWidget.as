package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private var var_1125:InfoStandPetData;
      
      private var var_140:Timer;
      
      private var var_817:InfoStandFurniView;
      ...
      private const const_1385:String = "infostand_furni_view";
      
      private const const_1592:int = 3000;
      
      private var var_199:InfoStandUserView;
      
      private var var_397:InfostandUserData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_817 = new InfoStandFurniView(this,const_1385);
         var_199 = new InfoStandUserView(this,const_1384);
         var_295 = new InfoStandPetView(this,const_1383);
         var_335 = new InfoStandBotView(this,const_1382);
         var_397 = new InfostandUserData();
         var_414 = new InfostandFurniData();
         var_1125 = new InfoStandPetData();
         var_140 = new Timer(const_1592);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_199.setTags(param1.tags,var_1999);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_691,onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_605,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_465,var_295.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_691,onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_605,onBadgeImage);
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_232:
               ...
               {
                  _loc2_ = param1.id == var_397.userRoomId;
                  break;
               }
               if(var_295 != null && false && var_295.window.visible)
               {
                  _loc2_ = param1.id == var_1125.roomIndex;
                  break;
               }
