package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1578:uint = 6710886;
      ...
      private const const_1584:String = "energy";
      
      private var var_1125:Map;
      
      private const const_1579:String = "nutrition";
      
      private var var_65:IItemListWindow;
      
      private const const_1583:uint = 3355443;
      
      private var var_232:IBorderWindow;
      
      private const const_1582:int = 158;
      
      private const const_1577:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_251:PetCommandTool;
      
      private const const_1581:uint = 11184810;
      
      private const const_1580:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_232 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_232 != null)
         {
            var_111 = var_232.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_232.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_232.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      {
         if(var_111 == null || var_232 == null || var_65 == null)
         {
            return;
         }
         ...
         var_232.height = NaN;
         _window.width = Math.max(var_232.width,var_65.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1125.getValue(var_672) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1580,param1.experience,param1.experienceMax);
         updateStateElement(const_1584,param1.energy,param1.energyMax);
         updateStateElement(const_1579,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_672 = param1.id;
         var_1125.remove(param1.id);
         var_1125.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_377,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1582,const_1577,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1581);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1583);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1578);
         return _loc5_;
      }
