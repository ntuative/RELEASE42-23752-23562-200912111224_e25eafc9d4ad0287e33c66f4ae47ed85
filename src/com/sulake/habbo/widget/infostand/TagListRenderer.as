package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1571:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1075 != null && var_1075.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_723 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_723 += param1.height + const_1572;
            return fit(param1);
         }
         param1.offset(_offsetX,var_723);
         _offsetX += param1.width + const_1571;
         return true;
      }
