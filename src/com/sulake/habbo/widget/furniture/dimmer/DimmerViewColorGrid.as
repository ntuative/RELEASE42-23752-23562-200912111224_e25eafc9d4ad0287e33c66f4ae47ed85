package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_1205:XML;
      
      private var var_296:IWindowContainer;
      
      private var var_392:IItemGridWindow;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_392.destroyGridItems();
         var_296 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1205) as IWindowContainer;
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_806.width,var_806.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_658.width,var_658.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_658,var_658.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_392.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_392.numGridItems)
         {
            return;
         }
         select(var_392.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_296 != null)
         {
            _loc2_ = var_296.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_806 = BitmapData(_loc3_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_selected"));
         var_658 = BitmapData(_loc3_.content);
      }
