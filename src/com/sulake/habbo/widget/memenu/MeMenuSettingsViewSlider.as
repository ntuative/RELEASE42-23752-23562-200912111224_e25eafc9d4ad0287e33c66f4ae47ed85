package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_815:MeMenuSettingsView;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_815.saveVolume(getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_550 != null)
            {
               ...
               var_1443 = _loc1_.width - _loc2_.width;
            }
         }
      }
      ...
      {
         return int(var_1443 * (Number(param1 - var_669) / (var_985 - var_669)));
      }
      ...
      {
         return param1 / var_1443 * (var_985 - var_669) + var_669;
      }
   }
}
