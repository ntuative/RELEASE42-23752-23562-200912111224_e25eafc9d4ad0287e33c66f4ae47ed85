package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_845 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_843 = _window.findChildByName("loader_bar");
         if(var_843 != null)
         {
            var_371 = var_843.width;
            var_173.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_845 != null)
         {
            var_845.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_845.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
