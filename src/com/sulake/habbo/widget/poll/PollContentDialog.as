package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_684[var_1007] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_300)
         {
            ...
            var_300 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_300.center();
            var_300.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1007;
         if(var_1007 < var_684.length)
         {
            _loc1_ = var_684[var_1007] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_684.length);
                  _loc2_.text = _loc6_;
               }
