package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_335:int = 10;
      
      private static const const_1031:Number = 18;
      
      private static const const_1367:Number = 10;
      
      private static const const_1368:Number = 8;
       
      
      private var var_1095:Number;
      ...
      {
         _widget.onItemMouseOut(var_909,var_907,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_909,var_907,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1097 = param1.chatType;
         var_909 = param1.userId;
         var_728 = param1.userName;
         var_907 = param1.userCategory;
         _message = param1.text;
         var_1095 = param1.userX;
         var_189 = param1.userImage;
         var_908 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1097)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_113:
               ...
               break;
            case RoomWidgetChatUpdateEvent.const_94:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_228:
         ...
         if(var_189 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_365 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_908 != 0)
            {
               _loc31_ = uint(var_908 >> 16 & 255);
               _loc32_ = uint(var_908 >> 8 & 255);
               _loc33_ = uint(var_908 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_335;
            }
            else
            {
               _loc19_.text = var_728 + ":";
               _loc19_.y += var_365;
               _loc19_.width = _loc19_.textWidth + const_335;
               _width += _loc19_.textWidth + const_335;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1097 == RoomWidgetChatUpdateEvent.const_228)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_728);
            }
            else if(var_1097 == RoomWidgetChatUpdateEvent.const_247)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_728);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_335 + _loc20_.textWidth + const_479;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_909,var_907,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_909,var_907,_roomId,_roomCategory,param1);
      }
