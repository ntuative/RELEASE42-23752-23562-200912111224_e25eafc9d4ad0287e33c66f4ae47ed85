package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_359:Sprite = null;
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_359 = new Sprite();
            var_359.addChild(new Bitmap(_image));
            var_359.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_359.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_359);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1311 != "")
         {
            HabboWebTools.openWebPage(var_1311);
         }
      }
      ...
      override public function dispose() : void
      {
         if(var_359 != null)
         {
            var_359.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_359 = null;
         }
         if(_image != null)
         {
