package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, ICoreUpdateReceiver
   {
      ...
      private var var_228:LatencyTracker = null;
      ...
      private var var_406:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_1002:int = -1;
      
      private var var_1242:LagWarningLogger = null;
      
      private var var_834:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_228 = new LatencyTracker();
         var_1242 = new LagWarningLogger();
         var_1243 = new Array(const_763);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1177,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1171,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_540,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_979,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_529:
               trackLoginStep(HabboLoginTrackingStep.const_15,String(_communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_22:
               ...
               break;
            case HabboCommunicationEvent.const_12:
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_228 != null)
            {
               var_228.communication = _communication;
               var_228.connection = param1;
            }
         }
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_290:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_178)
         {
            Component(var_178).events.addEventListener(HabboConfigurationEvent.const_9,onConfigurationLoaded);
            if(var_228 != null)
            {
               var_228.configuration = var_178;
            }
            if(var_229 != null)
            {
               var_229.configuration = var_178;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_452.events.addEventListener(AdEvent.const_354,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_979,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_540,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_12,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_707,onHotelViewEvent);
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_418:
               var_1242.registerWarning(LagWarningLogger.const_928);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_834)
            {
               var_834.release(new IIDHabboWindowManager());
               var_834 = null;
            }
            if(var_452)
            {
               var_452.release(new IIDHabboAdManager());
               var_452 = null;
            }
            if(_navigator)
            {
            ...
            if(var_27)
            {
               if(true)
               {
                  Component(var_27).events.removeEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_CLOSED,onInvetoryTrackingEvent);
                  Component(var_27).events.removeEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_FURNI,onInvetoryTrackingEvent);
                  Component(var_27).events.removeEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_POSTERS,onInvetoryTrackingEvent);
                  Component(var_27).events.removeEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_BADGES,onInvetoryTrackingEvent);
                  Component(var_27).events.removeEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_ACHIEVEMENTS,onInvetoryTrackingEvent);
                  Component(var_27).events.removeEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_TRADING,onInvetoryTrackingEvent);
               }
            ...
            if(var_177)
            {
               if(true)
               {
                  ...
                  Component(var_177).events.removeEventListener(HabboFriendListTrackingEvent.const_290,onFriendlistTrackingEvent);
               }
            ...
            if(var_406)
            {
               if(true)
               {
                  var_406.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_406.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_406.release(new IIDHabboHelp());
               var_406 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_418,onLagWarningEvent);
               }
            }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_178)
         {
            Component(var_178).events.removeEventListener(HabboConfigurationEvent.const_9,onConfigurationLoaded);
         }
      }
      ...
      {
         var_406 = param2 as IHabboHelp;
         var_406.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_406.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_17,onCoreRunning);
         }
      }
      ...
      {
         var_834 = IHabboWindowManager(param2);
         if(var_834)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1002 > -1 && _loc2_ < var_1002)
         {
            ++var_1472;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1472);
         }
         if(var_1002 > -1 && _loc2_ - var_1002 > 15000)
         {
            ++var_1473;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1473);
         }
         var_1002 = _loc2_;
         if(var_229 != null)
         {
         ...
         if(var_228 != null)
         {
            var_228.update(param1);
         }
         if(var_1242 != null)
         {
            var_1242.update(param1);
         }
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_418,onLagWarningEvent);
      ...
      private function onInventoryReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_27).events.addEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_CLOSED,onInvetoryTrackingEvent);
         Component(var_27).events.addEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_FURNI,onInvetoryTrackingEvent);
         Component(var_27).events.addEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_POSTERS,onInvetoryTrackingEvent);
         Component(var_27).events.addEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_BADGES,onInvetoryTrackingEvent);
         Component(var_27).events.addEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_ACHIEVEMENTS,onInvetoryTrackingEvent);
         Component(var_27).events.addEventListener(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_TRADING,onInvetoryTrackingEvent);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_177).events.addEventListener(HabboFriendListTrackingEvent.const_290,onFriendlistTrackingEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_707)
         {
