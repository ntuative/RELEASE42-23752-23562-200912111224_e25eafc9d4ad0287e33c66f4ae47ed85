package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         var_1500 = int(var_178.getKey("latencytest.interval"));
         var_1498 = int(var_178.getKey("latencytest.report.index"));
         var_2128 = int(var_178.getKey("latencytest.report.delta"));
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(var_488 == null || var_161 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = var_488.getValue(_loc2_.requestId);
         var_488.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         var_161.push(_loc4_);
         if(var_161.length == var_1498 && var_1498 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - var_1501) > var_2128 || var_1501 == 0)
            {
               var_1501 = _loc9_;
