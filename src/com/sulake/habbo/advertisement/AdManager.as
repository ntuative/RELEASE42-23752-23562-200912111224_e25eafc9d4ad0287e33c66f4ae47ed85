   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_354,0,0,_loc4_,var_1419,var_1907,var_1908));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1911 = int(_config.getKey("interstitial.interval","30000"));
         var_1910 = int(_config.getKey("interstitial.show.time","5000"));
         var_1420 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1419 = _loc2_.clickUrl;
         if(var_1177 != "" && var_1419 != "")
         {
            _loc3_ = var_1177;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(var_1178 != "")
         {
            ...
            if(var_220 == null)
            {
               var_220 = new Timer(var_1910,1);
               var_220.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_220.reset();
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_353,0,0,param1.bitmapData,var_1909));
            var_647 = getTimer();
         }
         else
         {
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1420 > 0 && var_1418 >= var_1420)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_647;
         if(_loc1_ > var_1911)
         {
            ++var_1418;
      ...
      {
         var_614 = param2 as IHabboCommunicationManager;
         if(var_614 == null)
         {
            return;
         }
         _connection = var_614.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_411));
         }
      }
