package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1575:String = "room_widget";
      
      private const const_1599:String = "room_desktop_layout_container";
      
      private const const_1035:String = "room_view";
      
      private var var_616:int = 50;
      
      private var var_2198:XML = null;
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_616;
               _loc2_.width = var_66.desktop.width - var_616;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_616;
               _loc2_.height = var_66.desktop.height - var_616;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_66.desktop.width;
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1575) == 0)
            {
