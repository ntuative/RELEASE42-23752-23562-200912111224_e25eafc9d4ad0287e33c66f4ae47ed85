package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1788:IHabboHelp = null;
      ...
      private var var_760:IRoomWidgetFactory = null;
      ...
      private var var_1052:IAvatarRenderManager = null;
      ...
      private var var_555:ISessionDataManager = null;
      
      private var var_2122:uint = 16777215;
      
      private var var_70:IHabboCatalog = null;
      
      private var var_27:IHabboInventory = null;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_470,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_474,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_613,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_693 = _roomEngine.loadRoomResources(var_47.roomResources);
            if(false)
            {
               var_9 = false;
         ...
         if(var_452 != null && true)
         {
            var_1268 = !var_452.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_47.roomId,var_47.roomCategory,var_269[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(var_234 != null)
         {
            ...
            {
               _loc5_ = var_234.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_470,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_474,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_613,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_33 = null;
         var_760 = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_2122);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < var_234.length)
         {
            _loc2_ = var_234.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_188 != null)
         {
            var_235.toolbarSize = var_188.size;
            var_235.toolbarOrientation = var_188.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            _roomEngine.handleRoomCanvasMouseEvent(var_269[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_760.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_578:
               ...
               if(var_1380 != null && _loc3_ == RoomObjectCategoryEnum.const_35)
               {
                  _loc7_ = var_47.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_370)
                  {
                     var_1380.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_475:
               ...
               break;
            case RoomEngineObjectEvent.const_702:
               if(true)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_121:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_885,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_234.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_725);
            _loc13_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_558);
            _loc14_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_673);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_221,canvasMouseHandler);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_277);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_446:
               ...
               var_182 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.WINDOW_TYPE_TOOLTIP,WindowStyle.const_264,WindowParam.const_75) as IToolTipWindow;
               var_182.setParamFlag(WindowParam.const_44,false);
      ...
      {
         if(var_693 == null || false)
         {
            return;
         }
         var _loc2_:int = var_693.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_693.splice(_loc2_,1);
         }
         if(false)
         {
            var_9 = true;
      ...
      {
         if(var_33 != null && var_47 != null && var_1268 && var_9)
         {
