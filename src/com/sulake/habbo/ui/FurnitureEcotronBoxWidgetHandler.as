package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_638,RoomWidgetEcotronBoxOpenMessage.const_648,RoomWidgetEcotronBoxOpenedMessage.const_1220];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_638:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_648:
