   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_724,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_386,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_724,onFigureUpdate);
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_166,onCreditBalance);
         }
         var_27 = _container.inventory;
         if(var_27 != null)
         {
            (var_27 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_999,onAvatarEffectsChanged);
            (var_27 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_680,onHabboClubSubscriptionChanged);
         }
         var_188 = _container.toolbar;
         if(var_188)
         {
            var_188.events.addEventListener(HabboToolbarEvent.const_81,onHabboToolbarEvent);
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_386,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_101:
               ...
               break;
            case HabboHelpTutorialEvent.const_386:
      ...
      private function onAvatarEffectsChanged(param1:Event = null) : void
      {
         ...
         if(var_27 != null)
         {
            _loc2_ = var_27.getAvatarEffects();
      ...
      private function onHabboClubSubscriptionChanged(param1:Event = null) : void
      {
         ...
         if(var_27 != null)
         {
            ...
            _container.events.dispatchEvent(new RoomWidgetHabboClubUpdateEvent(var_27.clubDays,var_27.clubPeriods,var_27.clubPastPeriods,_loc2_));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_607);
         _loc1_.push(RoomWidgetDanceMessage.const_522);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_727);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_546);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_664);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_495);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_582);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_703);
         _loc1_.push(RoomWidgetStopEffectMessage.const_513);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1269);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_971);
         _loc1_.push(RoomWidgetToolbarMessage.const_561);
         _loc1_.push(RoomWidgetToolbarMessage.const_639);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_643);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1273);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_943);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_720);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_665);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_695);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_661);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1240);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_730);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_564);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_590);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_665:
               if(_container != null && false)
               {
                  _loc8_ = new HabboToolbarEvent(HabboToolbarEvent.const_61);
                  _loc8_.iconId = HabboToolbarIconEnum.MEMENU;
                  _container.toolbar.events.dispatchEvent(_loc8_);
               }
               break;
            case RoomWidgetWaveMessage.const_607:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_522:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_727:
               if(var_27 != null)
               {
                  _loc11_ = var_27.getAvatarEffects();
                  _container.events.dispatchEvent(new RoomWidgetUpdateEffectsUpdateEvent(_loc11_));
               }
               break;
            case RoomWidgetSelectEffectMessage.const_546:
               if(var_27 != null)
               {
                  _loc12_ = param1 as RoomWidgetSelectEffectMessage;
                  var_27.setEffectSelected(_loc12_.effectType);
               }
               break;
            case RoomWidgetSelectEffectMessage.const_664:
               if(var_27 != null)
               {
                  ...
                  var_27.setEffectDeselected(_loc13_.effectType);
               }
               break;
            case RoomWidgetOpenCatalogMessage.const_703:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(var_70 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_547)
               {
                  var_70.openCatalogPage(CatalogPageName.const_329,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_582:
               ...
               if(var_27 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_966:
                        var_70.openCatalogPage(CatalogPageName.const_1185,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_948:
                        var_27.toggleInventoryPage(InventoryCategory.const_227);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1277:
                        var_27.toggleInventoryPage(InventoryCategory.const_69);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1166:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_495:
            case RoomWidgetStopEffectMessage.const_513:
               Logger.log("STOP ALL EFFECTS");
               if(var_27 != null)
               {
                  var_27.deselectAllEffects();
               }
               break;
            case RoomWidgetSetToolbarIconMessage.const_919:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_971:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_720:
               ...
               break;
            case RoomWidgetToolbarMessage.const_561:
               _loc5_ = param1 as RoomWidgetToolbarMessage;
               if(var_188)
               {
                  var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_27 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
                     ...
                     _container.events.dispatchEvent(new RoomWidgetHabboClubUpdateEvent(var_27.clubDays,var_27.clubPeriods,var_27.clubPastPeriods,_loc14_));
                  }
            ...
            case RoomWidgetToolbarMessage.const_639:
               ...
               if(var_188)
               {
                  var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_424,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_643:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_378,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_902));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_378,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1204));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_716));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_695:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_661:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_293,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_730:
            ...
            case RoomWidgetStoreSettingsMessage.const_564:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_293,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_590:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_709));
               }
               break;
            default:
