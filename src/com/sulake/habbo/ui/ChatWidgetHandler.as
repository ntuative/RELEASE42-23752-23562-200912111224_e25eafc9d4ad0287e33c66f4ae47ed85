package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_423:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_424.length)
            {
               _loc2_ = var_424.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_424.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_588.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_424.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_588.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_684,RoomWidgetChatSelectAvatarMessage.const_672];
      }
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_148,_container.roomSession,0,"Version 23752-23562-200912111121");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_287);
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_454);
                                 _container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
                     ...
                     switch(_loc3_.chatType)
                     {
                        case RoomWidgetChatMessage.const_123:
                           ...
                           break;
                        case RoomWidgetChatMessage.const_94:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_709 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_709);
            }
            if(var_423 == null)
            {
               var_422.x = 0;
               var_422.y = 0;
               var_422.z = 0;
               var_423 = _loc4_.getScreenPoint(var_422);
               var_709 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_422.x = 0;
            var_422.y = 0;
            var_422.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_422);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_423.x || _loc8_.y != var_423.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_423,_loc5_));
