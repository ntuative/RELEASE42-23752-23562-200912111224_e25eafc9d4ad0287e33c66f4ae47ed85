package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_429:
               ...
               {
                  case RoomSessionQueueEvent.const_1002:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_778:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc5_.length > 1)
               {
                  ...
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1148) + 1;
                  }
               }
               else
               {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_778);
               break;
            case RoomWidgetRoomQueueMessage.const_537:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_1002);
               break;
            case RoomWidgetRoomQueueMessage.const_719:
               if(false)
               {
                  _container.catalog.openCatalogPage(CatalogPageName.const_329,true);
               }
         }
         return null;
      }
      ...
      {
         return [RoomSessionQueueEvent.const_429];
      }
