package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1461:Number = 15;
      
      private var _events:IEventDispatcher;
      
      private var var_250:ToolbarBarMenuAnimator;
      
      private var var_1462:Number = 5;
      ...
      private var var_997:Boolean = true;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_200 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_53,HabboWindowStyle.const_864,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_997 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_997)
         {
         ...
         var_1240 = _loc7_.toolbar.@margin_bottom;
         var_1461 = _loc7_.toolbar.@min_group_margin;
         var_1462 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_266,param1,param2,_window,var_250);
         createGroupsFromXmlList(_loc9_,var_560,param1,param2,var_200,var_250);
         alignWindows();
      }
      ...
      public function dispose() : void
      {
         ...
         while(false)
         {
            _loc1_ = var_266.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         while(false)
         {
            _loc1_ = var_560.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(_window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_141,var_478,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         {
            _loc3_ = var_266[_loc2_];
            _loc6_ += _loc3_.method_7 * _loc3_.defaultIconSize;
            _loc2_++;
         }
         var _loc7_:* = 0;
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1461,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1240) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1461,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1240) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_141,var_478);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         var _loc3_:int = 0;
         _loc3_ = 0;
         while(_loc3_ < var_266.length)
         {
            _loc2_ = var_266[_loc3_];
         ...
         _loc3_ = 0;
         while(_loc3_ < var_560.length)
         {
            _loc2_ = var_560[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_478);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_141,var_478);
         }
      }
