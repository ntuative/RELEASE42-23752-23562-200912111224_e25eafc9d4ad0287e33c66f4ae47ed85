package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_784 = new Array();
         _state = param1.id;
         var_1108 = param1.nextState;
         var_1175 = param1.loop;
         if(param1.background != null)
         {
            var_785 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_786.push(new XML());
               var_784.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_784[var_59] = param6.clone();
         }
      ...
      {
         if(var_1175 == true || var_645 == 0)
         {
            if(false)
            {
               ++var_59;
               if(var_59 >= var_786.length)
               {
                  var_59 = 0;
                  ++var_645;
               }
      ...
      {
         return var_786.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1175 == false && var_645 == 1 && var_1108 != _state;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_785 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_785.width),Math.max(param2.height,var_785.height));
            _loc3_.copyPixels(var_785,var_785.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_59 <= var_784.length)
         {
            _loc2_ = var_784[var_59];
