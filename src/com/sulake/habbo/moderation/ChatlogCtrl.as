package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1312:IMessageComposer;
      ...
      {
         var_765 = IWindowContainer(var_56.getXmlWindow("chatlog_roomheader"));
         var_766 = IWindowContainer(var_56.getXmlWindow("chatlog_chatline"));
         ...
         var_56.connection.send(var_1312);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_765.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_766.clone());
