package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function onRoomVisits(param1:RoomVisitsData) : void
      {
         ...
         var_59.caption = "Room visits: " + param1.userName;
         populate();
         onResizeTimer(null);
         var_59.visible = true;
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1878.clone());
         ...
         new OpenRoomTool(var_59,var_56,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
      ...
      {
         var_1878 = IWindowContainer(var_56.getXmlWindow("roomvisits_row"));
         ...
         var_59 = IFrameWindow(var_56.getXmlWindow("roomvisits_frame"));
         _list = IItemListWindow(var_59.findChildByName("visits_list"));
