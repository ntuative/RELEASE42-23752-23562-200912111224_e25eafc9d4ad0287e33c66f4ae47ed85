package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_769:int = 31536000;
      
      private static const const_767:int = 86400;
      
      private static const const_770:int = 3600;
      
      private static const const_768:int = 60;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_768) + " mins ago";
         }
         if(param1 < 2 * const_767)
         {
            return Math.round(param1 / const_770) + " hours ago";
         }
         if(param1 < 2 * const_769)
         {
            return Math.round(param1 / const_767) + " days ago";
         }
         return Math.round(param1 / const_769) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_56,WindowTracker.const_986,_data.userId),_callerFrame,var_1008,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_841.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_56.getXmlWindow("user_info"));
            var_841.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new ModActionCtrl(var_56,_data.userId,_data.userName,var_1247),_callerFrame,var_1008,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new RoomVisitsCtrl(var_56,_data.userId),_callerFrame,var_1008,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new SendMsgsCtrl(var_56,_data.userId,_data.userName,var_1247),_callerFrame,var_1008,false,true);
      }
