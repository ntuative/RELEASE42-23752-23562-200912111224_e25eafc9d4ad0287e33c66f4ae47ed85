package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_826:String = "issue_bundle_open";
      
      public static const const_714:String = "issue_bundle_my";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_146 = new Map();
         var_856 = new Map();
         var_575 = new IssueBrowser(this,var_62.windowManager,var_62.assets);
         var_695 = [];
         var_857 = [];
         var_1020 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1020.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:IssueBundle = var_146.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_856.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = var_146.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     var_146.remove(_loc3_.id);
                     removeHandler(_loc3_.id);
                  }
                  var_856.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1158)
         {
            var_154.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_146)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_856.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_856.add(param1.issueId,_loc2_);
            var_146.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         ...
         if(param1.state == IssueMessageData.const_134)
         {
            ...
            _loc8_ = var_857.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1020.remove(param1);
         var_1020.add(param1,_loc3_);
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         var_857 = var_857.concat(param1);
      }
      
      public function closeBundle(param1:int, param2:int) : void
      {
         var _loc3_:IssueBundle = var_146.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:* = var_1020.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function autoPick() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = var_146.getValues();
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_575 == null || !var_575.isOpen())
         {
            var_62.soundManager.playSound(HabboSoundTypesEnum.const_798);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_856.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_146.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = var_146.getValues();
