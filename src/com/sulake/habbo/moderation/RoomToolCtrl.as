package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_637:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_56,WindowTracker.const_580,_data.flatId),var_59,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_376);
         if(param1.flatId != var_376)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_376);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_637.isSelected);
         var_56.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1313,_loc2_,var_407.text,"",""));
         if(false)
         {
            var_56.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_964.isSelected,var_965.isSelected,var_637.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1120);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1139);
      }
      ...
      public function populate() : void
      {
         ...
         var_637 = ICheckBoxWindow(var_59.findChildByName("kick_check"));
         var_964 = ICheckBoxWindow(var_59.findChildByName("lock_check"));
         var_965 = ICheckBoxWindow(var_59.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         var_56.connection.send(new GetModeratorRoomInfoMessageComposer(var_376));
         Logger.log("BEGINNING TO SHOW: " + var_376);
      }
   }
}
