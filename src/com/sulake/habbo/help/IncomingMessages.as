package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_42.tellUI(HabboHelpViewEnum.const_213,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_42.tellUI(HabboHelpViewEnum.const_245,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_42.tellUI(HabboHelpViewEnum.const_141);
      }
      ...
      {
         var_42.showUI(HabboHelpViewEnum.const_286);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_42.showUI(HabboHelpViewEnum.const_406);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_42.showUI(HabboHelpViewEnum.const_576);
         var_42.tellUI(HabboHelpViewEnum.const_576,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_370)
            {
         ...
         var_42.tellUI(HabboHelpViewEnum.const_715);
      }
