package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_639:FaqCategory;
      ...
      {
         super();
         var_638 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_639 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_136 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_638.hasItem(param1))
         {
            var_638.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_639.hasItem(param1))
         {
            var_639.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
