package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_629 == null || _loc3_ < 0 || _loc3_ >= var_629.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_629[_loc3_];
            main.showUI(HabboHelpViewEnum.const_645);
            main.tellUI(HabboHelpViewEnum.const_645,null);
         }
      }
   }
}
