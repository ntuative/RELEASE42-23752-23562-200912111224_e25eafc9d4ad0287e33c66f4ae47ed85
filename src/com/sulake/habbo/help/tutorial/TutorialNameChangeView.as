package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1931:uint = 11129827;
      ...
      private var var_795:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_56.localization.registerParameter("help.tutorial.name.available","name",var_389);
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "button_usecurrent":
                  var_389 = var_56.help.ownUserName;
                  showConfirmationView(true);
                  break;
               case "button_name_check":
                  if(_loc3_.text.length < 1)
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            var_56.localization.registerParameter("help.tutorial.name.confirmation","name",var_389);
         }
         if(var_259 == null)
         {
            var_259 = var_56.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_259 == null)
            {
               return;
            }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_795 = new NameSuggestionListRenderer(var_56);
         var _loc6_:int = var_795.render(param3,_loc5_);
         var _loc7_:int = 0;
