package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_1548:UserRegistry;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_123:TutorialUI;
      
      private var var_1315:IHabboLocalizationManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_61:HelpUI;
      
      private var var_1317:IHabboConfigurationManager;
      
      private var var_188:IHabboToolbar;
      
      private var var_614:IHabboCommunicationManager;
      ...
      private var var_1053:CallForHelpData;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1053 = new CallForHelpData();
         var_1548 = new UserRegistry();
      ...
      {
         var_1053.reportedUserId = param1;
         var_1053.reportedUserName = param2;
         var_61.showUI(HabboHelpViewEnum.const_286);
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_188 != null)
         {
            var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_127,HabboToolbarIconEnum.HELP));
         }
      }
      ...
      private function createHelpUI() : Boolean
      {
         ...
         {
            var_61 = new HelpUI(this,_assetLibrary,_windowManager,var_1315,var_188);
         }
         return var_61 != null;
      }
      ...
      {
         var_1315 = IHabboLocalizationManager(param2);
      ...
      {
         var_614 = IHabboCommunicationManager(param2);
         var_1316 = new IncomingMessages(this,var_614);
      ...
      {
         if(var_614 != null && param1 != null)
         {
            var_614.getHabboMainConnection(null).send(param1);
         }
      }
      ...
      {
         var_1317 = IHabboConfigurationManager(param2);
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return var_1317.getKey(param1,param2,param3);
      }
   }
}
