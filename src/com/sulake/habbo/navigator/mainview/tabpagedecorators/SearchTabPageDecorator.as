package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1479:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_196,Tabs.const_206,"-1",MainViewCtrl.const_519);
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1479 == null)
         {
            ...
            var_1479 = new TextSearchInputs(_navigator,false,_loc4_);
         ...
         {
            var_1479.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
