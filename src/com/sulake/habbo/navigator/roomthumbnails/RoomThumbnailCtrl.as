package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2002:IWindowContainer;
      ...
      {
         setEnabled(_bgTabButton,this.var_91.mode != ThumbnailEditorModel.const_36);
         setEnabled(var_1445,this.var_91.mode != ThumbnailEditorModel.const_51);
         setEnabled(var_1444,this.var_91.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_91.mode = ThumbnailEditorModel.const_36;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1444 = IButtonWindow(find("obj_tab"));
         var_2002 = IWindowContainer(find("tile_grid"));
         var_2001 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1444,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2002;
         _loc1_.visible = true;
