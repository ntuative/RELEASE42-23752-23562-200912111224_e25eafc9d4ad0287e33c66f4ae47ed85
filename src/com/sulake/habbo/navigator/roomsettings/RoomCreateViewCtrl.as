package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_858:RoomLayout;
      ...
      private var var_1021:TextFieldManager;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1274 = new Timer(100);
         var_1274.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_68 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_1021 = new TextFieldManager(_navigator,ITextFieldWindow(var_34.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1021.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_2079 = _navigator.data.hcMember;
      }
      ...
      {
         var_1021.goBackToInitialState();
         var_1021.input.textBackgroundColor = 4294967295;
         var_858 = var_68[0];
         if(var_2079 != _navigator.data.hcMember)
         {
      ...
      {
         var _loc1_:Boolean = var_1021.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_858.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1275 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1275 = true;
            _loc3_.y = 1;
