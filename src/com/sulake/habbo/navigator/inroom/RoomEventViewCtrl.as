package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_659.getText();
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1436.visible = true;
         var_1966.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_659.setText(param1.eventDescription);
         var_807.setText(getTagFromEvent(param1,1));
         var_809.setText(getTagFromEvent(param1,2));
         var_1206.visible = false;
         var_1208.visible = true;
         var_1207.visible = true;
         var_1434.visible = false;
         var_1435.visible = true;
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1436 = IWindowContainer(find("event_type_disabled_cont"));
            var_1966 = ITextWindow(find("event_type_disabled_text"));
            var_1434 = ITextWindow(find("create_caption"));
            var_1435 = ITextWindow(find("edit_caption"));
            var_1206 = IButtonWindow(find("create_button"));
            var_1208 = IButtonWindow(find("edit_button"));
            var_1965 = IButtonWindow(find("cancel_button"));
            var_1207 = IButtonWindow(find("end_button"));
            var_808 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1206,onCreateButtonClick);
            Util.setProcDirectly(var_1208,onEditButtonClick);
            Util.setProcDirectly(var_1207,onEndButtonClick);
            Util.setProcDirectly(var_1965,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_659 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_807 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_809 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_659.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
