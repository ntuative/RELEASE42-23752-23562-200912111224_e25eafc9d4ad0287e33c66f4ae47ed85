package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1395:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_318 && _loc4_.state != FriendRequest.const_309)
            {
      ...
      {
         var_1492 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1493 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1493.procedure = onDismissAllButtonClick;
         var_1492.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
