package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1760:IAvatarRenderManager;
      
      private var var_1437:AvatarSearchResults;
      
      private var var_124:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_810:FriendRequests;
      ...
      private var var_1972:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_381:FriendListTabs;
      
      private var var_1971:IHabboNotifications;
      ...
      {
         var_1972 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_333 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1437 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_810.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_810.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_381.findTab(FriendListTab.const_93).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_810.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_810 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_333.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_333.addCategory(new FriendCategory(FriendCategory.const_977,getText("friendlist.friends")));
         var_333.addCategory(new FriendCategory(FriendCategory.const_447,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_333.addFriend(new Friend(_loc4_));
         }
         var_381 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_127,HabboToolbarIconEnum.FRIENDLIST));
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_76);
      ...
      {
         var _loc2_:IAvatarImage = var_1760.createAvatarImage(param1,AvatarScaleType.const_92);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1760 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_810.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_381.findTab(FriendListTab.const_93);
      ...
      {
         var_1971 = param2 as IHabboNotifications;
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_381.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_290));
            }
            else
            {
               switch(_loc1_.id)
               {
                  case FriendListTab.const_76:
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1437.searchReceived(_loc2_.friends,_loc2_.others);
