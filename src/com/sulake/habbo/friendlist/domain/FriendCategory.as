package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_299:int = 100;
      ...
      {
         return Math.ceil(this.var_221.length / const_299);
      }
      ...
      {
         if(this.var_792 >= this.getPageCount())
         {
            this.var_792 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         {
            _loc4_ = var_221[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               var_221.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_792 + 1) * const_299,this.var_221.length);
      }
