package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1516:IWindowContainer;
      
      public static var var_1290:IWindowContainer;
      
      public static var var_1033:int = 6710886;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1516 == null)
         {
            ...
            var_1516 = _controller.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_602 != null)
         {
            toggleCategoryView(var_602,true);
         }
      }
