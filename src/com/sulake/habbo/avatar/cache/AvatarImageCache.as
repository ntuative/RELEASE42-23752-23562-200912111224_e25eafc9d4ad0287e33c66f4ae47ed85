package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1366:int = 60000;
      ...
      private var var_721:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_539)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_416)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_77.getParts(param1,(var_721 as AvatarImage).getFigure(),_loc6_,var_1076,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_77.getCanvas(var_197,var_1076);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1351[param1])
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_951 || _loc32_ == AvatarAction.const_503) && (_loc6_ == AvatarBodyPartType.const_284 || _loc6_ == AvatarBodyPartType.const_1211 || _loc6_ == AvatarBodyPartType.const_1138) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_197 == AvatarScaleType.const_50)
            {
               _loc30_.x += 67;
            }
            else
