package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_378:PartSetsData;
      
      private var var_1750:PartOffsetData;
      
      private var var_748:AvatarActionManager;
      
      private var var_153:IAssetLibrary;
      
      private var var_2200:IAssetLibrary;
      
      private var var_1295:Boolean = false;
      
      private var var_1749:AvatarRenderManager;
      ...
      private var var_1373:AvatarStructureDownloadSet;
      
      private var var_620:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_378 = new PartSetsData();
         _animationData = new AnimationData();
         var_1373 = new AvatarStructureDownloadSet();
         var_620 = new AnimationManager();
         var_619 = param4;
         var_1750 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_748.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_748.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_748.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_620.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_378.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_378.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1349[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_748.getDefaultActionType();
         var _loc7_:Array = var_378.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_620.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            if(_loc23_ != null)
            {
               _loc24_ = var_451.getPalette(_loc23_.paletteID).getColor(_loc22_);
               ...
               if(_loc25_ != null)
               {
                  ...
                  for each(_loc26_ in _loc25_.parts)
                  {
                     if(_loc9_.indexOf(_loc26_.type) > -1)
                     {
                        ...
                        _loc13_ = var_378.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc33_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_378.getPartDefinition(_loc11_);
                     _loc35_ = false;
                     _loc36_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_619 + " ready to go!");
         if(var_619 == AvatarType.HUMAN)
         {
            var_378.getPartDefinition("ri").appendToFigure = true;
            var_378.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.HUMAN:
               var_1373.add(new AvatarStructureDownload(var_153,_loc5_,var_451));
               break;
            case AvatarType.PET:
         }
         var_1373.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_620.getAnimation(param1);
      }
      ...
      {
         var_748 = new AvatarActionManager(var_153,var_619);
      }
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_153.hasAsset("dance" + _loc1_))
         {
            ...
            var_620.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_451.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_451.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_748.sortActions(param1);
      }
   }
}
