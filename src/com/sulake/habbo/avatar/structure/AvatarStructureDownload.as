package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_998:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var _assets:IAssetLibrary;
      
      private var var_2035:IStructureData;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            var_1459 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         var_2035.append(var_1459);
         dispatchEvent(new Event(AvatarStructureDownload.const_998));
      }
   }
}
