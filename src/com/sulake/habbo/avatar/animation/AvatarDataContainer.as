package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1338,var_1340,var_1336,_alphaMultiplier);
         var_1001 = generatePaletteMapForGrayscale(var_2064,var_2063);
      }
      
      public function get reds() : Array
      {
         return var_1001.getValue("reds") as Array;
      }
      ...
      {
         return var_1001.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1001.getValue("greens") as Array;
      }
      ...
      {
         return var_1001.getValue("alphas") as Array;
      }
