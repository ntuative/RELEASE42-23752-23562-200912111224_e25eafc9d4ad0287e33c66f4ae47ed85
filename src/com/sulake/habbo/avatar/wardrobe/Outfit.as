package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit
   {
      ...
      {
         var_1344 = _controller.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.const_92);
         var_1344.setDirection(AvatarSetType.const_38,int(FigureData.const_976));
