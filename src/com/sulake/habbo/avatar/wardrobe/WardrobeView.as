package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements IAvatarEditorCategoryView
   {
      ...
      private var var_656:IItemListWindow;
      
      private var var_541:IItemListWindow;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_804:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_656 = _window.findChildByName("mylooks") as IItemListWindow;
         var_541 = _window.findChildByName("hotlooks") as IItemListWindow;
         var_804 = _window.findChildByName("selector") as IItemListWindow;
         var_1431 = _window.findChildByName("habboClubNotificationContainer") as IWindowContainer;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "habboClubLink":
                  ...
                  var_91.controller.catalog.openCatalogPage(CatalogPageName.const_329,true);
            }
         }
      ...
      private function myLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            var_91.selectMyLook(var_656.getListItemIndex(param2.parent));
         }
      }
      ...
      private function initSelector() : void
      {
         ...
         {
            var_804.removeListItem(_loc1_.window);
            _loc1_.dispose();
         }
         var_542 = [];
         while(true)
         {
            ...
            var_804.addListItem(_loc1_.window);
      ...
      public function updateMyLooks(param1:int) : void
      {
         ...
         else
         {
            ...
            while(false)
            {
               var_656.removeListItemAt(0);
            }
            for each(_loc2_ in var_91.myLooks)
            {
               var_656.addListItem(_loc2_.view.window);
      ...
      private function myLooksSelectorEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_804.getListItemIndex(param2);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_803 * 8 + var_541.getListItemIndex(param2.parent);
