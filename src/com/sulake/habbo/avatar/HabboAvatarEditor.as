package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_981:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_981.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_982)
         {
            ...
            var_333 = new Map();
            var_333.add(AvatarEditorCategory.const_992,new GenericModel(this));
            var_333.add(AvatarEditorCategory.const_46,new HeadModel(this));
            var_333.add(AvatarEditorCategory.const_284,new TorsoModel(this));
            var_333.add(AvatarEditorCategory.const_1282,new LegsModel(this));
            var_333.add(AvatarEditorCategory.const_712,new WardrobeModel(this));
            var_982 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_333.getValue(AvatarEditorCategory.const_712);
         if(_loc1_ != null)
         {
         }
      }
      ...
      private function method_6(param1:HabboInventoryHabboClubEvent = null) : void
      {
         requestSavedOutfits();
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_333.getValue(AvatarEditorCategory.const_712);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_981.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc13_ in _loc10_.colors)
            {
               ...
               {
                  _loc16_ = new AvatarEditorColorItem(AvatarEditorView.var_1516.clone() as IWindowContainer,param1,_loc13_);
                  _loc4_.push(_loc16_);
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1305)
               {
                  _loc19_ = true;
               }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_393 == null)
            {
               var_393 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_53,HabboWindowStyle.const_39,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_393.addChild(_view.window);
               var_393.center();
               var_393.visible = false;
            }
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_992);
         if(var_178 != null)
         {
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1052 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_27 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_680,method_6);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_981 = var_1052.getFigureData(AvatarType.HUMAN);
      }
