package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_437:IBitmapWrapperWindow;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1218 = _loc4_.content as BitmapData;
         if(_window != null)
         {
            var_437 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      {
         var_437.bitmap = new BitmapData(var_437.width,var_437.height,true,16777215);
         var_437.bitmap.copyPixels(var_1218,var_1218.rect,new Point(0,0 - 0 - 8));
         var_437.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}
