package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorColorItem
   {
      ...
      private const const_1587:int = 8947848;
      ...
      private var var_833:IPartColor;
      ...
      public function AvatarEditorColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         var_1237 = _loc5_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_1237.width,var_1237.height,true,0);
            _loc4_ = var_1237.clone();
            _loc4_.colorTransform(_loc4_.rect,var_833.colorTransform);
         ...
         if(_loc3_ != null)
         {
            _loc3_.bitmap = new BitmapData(var_992.width,var_992.height,true,16777215);
            _loc3_.bitmap.copyPixels(var_992,var_992.rect,new Point(0,0),null,null,true);
            if(!_isSelected)
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               _loc5_.bitmap.copyPixels(var_1471,var_1471.rect,new Point(0,0),null,null,true);
            }
         }
      }
