package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_738:int = 2;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1343)
         {
            case RecyclerStatusMessageEvent.const_1163:
               var_244 = const_336;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_845:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1181:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1343 != RecyclerStatusMessageEvent.const_845;
      }
      
      private function get statusActive() : Boolean
      {
         return var_244 != const_737;
      }
      ...
      {
         return active && var_244 == const_336;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_904:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1160:
