package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2253:String = "magic.pixels";
      
      private var var_2254:String = "catalog.page.club";
      
      private var var_2289:String = "magic.credits";
      ...
      {
         var_70.openCatalogPage(var_2254,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_274.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in var_274)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = var_274.indexOf(_loc6_);
            var_274.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
