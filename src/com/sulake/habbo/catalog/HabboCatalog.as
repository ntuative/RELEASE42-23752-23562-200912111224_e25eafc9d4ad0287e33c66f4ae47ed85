package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_226:IMarketPlace;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_680:PurchaseConfirmationDialog;
      ...
      private var var_404:ICatalogNavigator;
      ...
      {
         return var_555.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2059 && var_759 != null)
         {
            var_759.playSound(HabboSoundTypesEnum.const_922);
         }
         var_2059 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_555.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_79)
         {
            _loc3_ = var_555.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               var_1241 = param1.session.isPrivateRoom;
               if(var_92 != null)
               {
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      public function openInventoryCategory(param1:String) : void
      {
         ...
         var_27.toggleInventoryPage(param1);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_404 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_680 == null)
            {
               var_680 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_680.showOffer(this,param1,param2,param3,_loc7_);
         }
      }
      ...
      private function createMarketPlace() : void
      {
         if(var_226 == null)
         {
            var_226 = new MarketPlaceLogic(this,_windowManager);
         }
      }
      ...
      {
         var _loc2_:BitmapDataAsset = (var_27 as Component).assets.getAssetByName("fx_icon_" + param1 + "_png") as BitmapDataAsset;
         if(_loc2_ != null)
         {
            return (_loc2_.content as BitmapData).clone();
         }
      ...
      {
         var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_127,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      public function requestInventoryFurniToRecycler() : int
      {
         ...
         return var_27.requestSelectedFurniToRecycler();
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_404.buildCatalogIndex(_loc2_);
         if(var_1000 != "")
         {
            var_404.openPage(var_1000);
            var_1000 = "";
         }
         else
         {
            var_404.openFrontPage();
         }
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2058 && var_759 != null)
         {
            var_759.playSound(HabboSoundTypesEnum.const_964);
         }
         var_2058 = false;
      }
      ...
      public function returnInventoryFurniFromRecycler(param1:int) : Boolean
      {
         ...
         return var_27.returnInventoryFurniFromRecycler(param1);
      }
   }
}
