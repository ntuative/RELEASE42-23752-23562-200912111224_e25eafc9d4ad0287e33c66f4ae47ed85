package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_362 >= var_279.length)
         {
            return "";
         }
         var petColor:IPetColor = var_279[var_362] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_507[var_1322] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_362 = param1.index;
         if(var_362 < 0 || var_362 > var_279.length)
         {
            var_362 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_889.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_207,onTextWindowEvent);
         var_889 = new Map();
         ...
         var_718 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_279 = [];
         var_507 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_718);
               if(_loc11_)
               {
                  var_507 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_507.length)
         {
            _loc12_ = var_507[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_718,_loc12_.id),getRaceLocalizationKey(var_718,_loc12_.id)));
            _loc6_++;
         }
         var_889.add(var_718,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_961,onApproveNameResult);
         _loc5_ = var_889.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_889.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_362 >= 0 && var_362 < var_279.length)
         {
            _loc7_ = var_279[var_362] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_507[var_1322] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_718,_loc3_.id,_loc2_,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_305,AvatarAction.const_711);
