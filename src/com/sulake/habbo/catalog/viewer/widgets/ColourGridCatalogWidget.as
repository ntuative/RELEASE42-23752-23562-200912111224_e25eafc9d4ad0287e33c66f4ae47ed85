   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function populateColourGrid() : void
      {
         ...
         for each(_loc1_ in var_1235)
         {
            ...
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_1237.width,var_1237.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_992.width,var_992.height,true,16777215);
