package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_774:PrizeViewer;
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            createLevelItem(var_631[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_774 = new PrizeViewer();
         var_889 = new Map();
         var_631 = recycler.getPrizeTable();
         if(var_631 == null)
         {
            return;
         }
         ...
         var_1833 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_631[0].prizes.length > 0)
         {
            select(var_631[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1833) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_774.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
