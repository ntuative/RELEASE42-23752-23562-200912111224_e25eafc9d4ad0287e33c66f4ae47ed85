package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_924:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_925 != null)
         {
            var_925.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_924 != null)
         {
            var_924.removeEventListener(WindowKeyboardEvent.const_125,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_925 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_925 != null)
         {
            var_925.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_924 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_924 != null)
         {
            var_924.addEventListener(WindowKeyboardEvent.const_125,windowKeyEventProcessor);
         }
      }
