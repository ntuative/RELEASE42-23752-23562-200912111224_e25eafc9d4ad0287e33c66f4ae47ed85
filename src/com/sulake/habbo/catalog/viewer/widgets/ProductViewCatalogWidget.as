package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_389:
                  ...
                  if(var_544 != null)
                  {
                     ...
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_544,var_1200,var_1294);
                  }
                  break;
               ...
               case Offer.const_380:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_79:
                        ...
                        _loc2_.previewCallbackId = _loc7_.id;
                        break;
                     case ProductTypeEnum.const_249:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_305,AvatarAction.const_531);
                              _loc13_.appendAction(AvatarAction.const_534,_loc6_.productClassId);
      ...
      override public function init() : void
      {
         ...
         var_1433 = new Point(var_90.x,var_90.y);
