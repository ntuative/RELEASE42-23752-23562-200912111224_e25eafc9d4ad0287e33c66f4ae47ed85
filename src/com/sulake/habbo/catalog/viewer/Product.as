package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1143:IProductData;
      ...
      {
         super();
         var_1142 = param1.productType;
         var_1144 = param1.furniClassId;
         var_943 = param1.extraParam;
         var_942 = param1.productCount;
         var_1141 = param1.expiration;
         var_1143 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_79:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_943);
               break;
