package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1364:String = "ctlg_";
       
      
      private var _localization:IPageLocalization;
      
      protected var var_1303:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_801:String;
      
      private var var_1190:EventDispatcher;
      
      private var _widgets:Array;
      
      private var _pageId:int;
      
      private var var_774:ICatalogViewer;
      ...
      {
         return _localization.hasLinks(var_801);
      }
      ...
      {
         var _loc2_:String = const_1364 + param1;
         ...
         var_1303 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1303) as IWindowContainer;
         if(_window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1162) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1136) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1190;
            _loc2_.init();
         }
         var_1190.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1190.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_801);
      }
