package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_1097:String = const_342;
      ...
      public static const const_493:String = "RCL_LOADER_READY";
      ...
      private var var_1016:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         var_691 = [];
         var_690 = [];
         var_2116 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2115 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_410 = new Map();
         _events = new Map();
      ...
      {
         var _loc2_:String = var_570.getValue(param1) as String;
      ...
      {
         if(var_181 != null && var_181.hasWorldType(const_273 + param1))
         {
            return var_181.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           if(_loc9_[0] as String == "s")
                           {
                              ...
                              if(var_691.indexOf(_loc14_) < 0)
                              {
                                 var_691.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              var_570.add(_loc10_,_loc11_);
                              if(var_690.indexOf(_loc14_) < 0)
                              {
                                 var_690.push(_loc14_);
                              }
                           }
                           _loc16_ = var_486.getValue(_loc14_);
                           if(_loc12_ > _loc16_)
                           {
                              var_486.remove(_loc14_);
                              var_486.add(_loc14_,_loc12_);
                           }
                        }
                     }
                  }
      ...
      {
         return [const_342,const_490,ROOM_CONTENT,const_771,const_772];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2116.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_172 && _loc5_ != RoomObjectLogicEnum.const_122)
         {
            _loc6_ = "@shadow";
      ...
      {
         if(var_691.indexOf(param1) >= 0)
         {
            return const_342;
         }
         if(var_690.indexOf(param1) >= 0)
         {
            return const_490;
         }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1176);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_570.getValue(param1) as String;
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2115.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_470,_loc5_);
         }
         else
         {
      ...
      private function continueInitilization() : void
      {
         if(var_2114)
         {
            ...
            if(var_1016 != null)
            {
               var_1016.dispatchEvent(new Event(const_493));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_181 != null)
         {
            return var_181.getWorldHeightScale(const_273 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1016 = param1;
            var_2117 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2112 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2113 = param2.getKey("public.room.dynamic.download.url","");
            var_2118 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         _state = const_773;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_172 && _loc5_ != RoomObjectVisualizationEnum.const_122)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_383.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_273 + param1) == RoomObjectCategoryEnum.const_56)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_181 != null)
         {
            return var_181.getWorldScale(const_273 + param1);
         }
         return 32;
      }
