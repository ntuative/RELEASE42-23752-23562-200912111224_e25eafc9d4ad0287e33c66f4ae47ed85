package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1381:int = 0;
      ...
      private const const_1586:int = 2;
      
      private var var_767:AvatarVisualizationData = null;
      ...
      {
         var_767 = param1 as AvatarVisualizationData;
         createSprites(const_1042);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc5_:* = var_382.getValue(_loc4_) as IAvatarImage;
         var _loc6_:String = _loc3_.getString(RoomObjectVariableEnum.const_152);
         var _loc7_:Number = new Date().valueOf();
         var _loc8_:Boolean = false;
         var _loc9_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_603);
         var _loc10_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_611);
         ...
         var _loc13_:Number = _loc7_ - var_1187;
         ...
         if(_loc19_ || _loc20_)
         {
            ...
            if(var_552 != _loc6_)
            {
               for each(_loc48_ in var_382.getKeys())
               {
                  var_382.remove(_loc48_);
               }
               _loc5_ = null;
            }
            if(_loc5_ == null)
            {
               _loc5_ = var_767.getAvatar(_loc6_,param1.scale);
               if(_loc5_ == null)
               {
                  return;
               }
               var_382.remove(_loc4_);
               var_382.add(_loc4_,_loc5_);
               var_552 = _loc6_;
            }
            ...
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_327);
            if(isNaN(_loc24_) || _loc3_.getString(RoomObjectVariableEnum.const_262) == "float")
            {
               _loc24_ = _loc23_;
            }
            else
            ...
            _loc25_ = _loc3_.getString(RoomObjectVariableEnum.const_262);
            _loc26_ = _loc3_.getString(RoomObjectVariableEnum.const_555);
            _loc5_.appendAction(AvatarAction.const_498,_loc25_,_loc26_);
            _loc27_ = false;
            if(_loc25_ == "lay")
            {
            ...
            _loc28_ = _loc3_.getNumber(RoomObjectVariableEnum.const_381);
            if(_loc28_ > 0 && _loc5_.getScale() == AvatarScaleType.const_50)
            {
               _loc50_ = _loc3_.getNumber(RoomObjectVariableEnum.const_390);
               _loc51_ = 3;
               _loc52_ = _loc7_ - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_305,AvatarAction.const_1228[_loc28_]);
               }
            }
            _loc29_ = _loc3_.getNumber(RoomObjectVariableEnum.const_850);
            if(_loc29_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_912,_loc29_);
            }
            _loc30_ = _loc3_.getNumber(RoomObjectVariableEnum.const_828);
            if(_loc30_ > 0)
            {
               _loc53_ = _loc3_.getNumber(RoomObjectVariableEnum.const_802);
               _loc54_ = 5;
               _loc55_ = _loc7_ - _loc53_;
               if(_loc55_ < _loc54_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_869,_loc30_);
               }
            }
            _loc31_ = _loc3_.getNumber(RoomObjectVariableEnum.const_563);
            _loc32_ = 0;
            if(_loc31_ > 0)
            {
               _loc56_ = _loc3_.getNumber(RoomObjectVariableEnum.const_670);
               _loc57_ = 100;
               _loc58_ = _loc7_ - _loc56_;
               if(_loc58_ < _loc57_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_799,_loc31_);
                  _loc59_ = 1;
                  while(_loc59_ < 10)
                  {
            ...
            _loc33_ = _loc3_.getNumber(RoomObjectVariableEnum.const_789);
            if(_loc32_ > 0)
            {
               _loc33_ = _loc32_;
            }
            if(_loc33_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_887,_loc33_);
            }
            if(_loc8_)
            {
               _loc5_.appendAction(AvatarAction.const_407);
            }
            _loc34_ = _loc3_.getNumber(RoomObjectVariableEnum.const_433) > 0;
            if(_loc34_ || _loc12_)
            {
               _loc5_.appendAction(AvatarAction.const_632);
            }
            if(_loc14_)
            {
               _loc5_.appendAction(AvatarAction.const_363);
            }
            _loc35_ = _loc3_.getNumber(RoomObjectVariableEnum.const_852);
            if(_loc35_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_534,_loc35_);
            }
            ...
            _loc42_ = getSprite(const_1586);
            if(_loc3_.getNumber(RoomObjectVariableEnum.const_840))
            {
               _loc42_.visible = true;
               _loc39_ = null;
               _loc38_ = null;
               ...
               if(_loc38_ != null)
               {
                  _loc39_ = var_767.getAvatarRendererAsset(_loc38_) as BitmapDataAsset;
               }
               if(_loc39_ != null)
               {
                  _loc42_.asset = _loc39_;
            ...
            var_768.push(getTimer() - _loc22_);
            if(false)
            {
               _loc76_ = 0;
               _loc77_ = "[";
               for each(_loc78_ in var_768)
               {
                  _loc76_ += _loc78_;
                  _loc77_ += "," + _loc78_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_382 != null)
         {
            _loc1_ = var_382.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_382.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
