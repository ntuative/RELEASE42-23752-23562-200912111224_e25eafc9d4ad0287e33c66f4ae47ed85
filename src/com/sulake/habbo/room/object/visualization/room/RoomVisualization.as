package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1140:int = 13421772;
      
      private static const const_1087:int = 16777215;
      
      public static const const_1118:int = 10066329;
      
      private static const const_1088:int = 13421772;
      
      public static const const_1207:int = 16777215;
      
      private static const const_1388:int = 0;
      
      public static const const_1208:int = 16777215;
      
      private static const const_1086:int = 10066329;
      
      private static const const_1085:int = 10066329;
      
      public static const const_1223:int = 13421772;
      ...
      private var var_995:uint = 16777215;
      
      private var var_83:RoomPlaneParser = null;
      
      private var var_1286:String = null;
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(var_83.getPlaneType(_loc4_) == RoomPlaneData.const_133)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < var_83.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_233)
            {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_235 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         {
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_556);
            _loc6_ = _loc3_.getString(RoomObjectVariableEnum.const_671);
            _loc7_ = _loc3_.getString(RoomObjectVariableEnum.const_509);
            updatePlaneTextureTypes(_loc6_,_loc5_,_loc7_);
            _loc8_ = _loc3_.getString(RoomObjectVariableEnum.const_894);
            if(_loc8_ != var_2042)
            {
               updatePlaneMasks(_loc8_);
               var_2042 = _loc8_;
            }
            _loc9_ = uint(_loc3_.getNumber(RoomObjectVariableEnum.const_681));
            if(_loc9_ != var_995)
            {
               var_995 = _loc9_;
            }
            var_2043 = Boolean(_loc3_.getNumber(RoomObjectVariableEnum.const_957));
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_178)
            {
               _loc12_ = uint(_loc11_.color);
               if(var_2043)
               {
                  _loc13_ = uint((_loc12_ & 255) * (var_995 & 255) / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * (var_995 >> 8 & 255) / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * (var_995 >> 16 & 255) / 255);
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_810);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_812);
         var _loc7_:int = 0;
         while(_loc7_ < var_83.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_233)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_178,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_235 && param2 != null)
               {
                  _loc5_.id = param2;
               }
               else if(_loc5_.type == RoomPlane.const_178 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
         ...
         while(_loc5_ < _planeMaskParser.maskCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc9_ < var_109.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_235 || _loc3_.type == RoomPlane.const_178 && _loc8_ == RoomPlaneBitmapMaskData.const_214)
                  {
