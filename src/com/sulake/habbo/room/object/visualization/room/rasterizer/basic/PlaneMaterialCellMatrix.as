package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1345:int = const_288;
      ...
      public static const const_266:int = const_102;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1, param5:Number = 1, param6:Number = -1, param7:Number = 1)
      {
         ...
         var_1817 = param6;
         var_1816 = param7;
         var_733 = new Vector3d();
         if(var_1367 == const_517)
         {
            var_1278 = false;
         }
      }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1510 == const_102)
         {
            _loc5_ = new Rectangle(0,0,var_39.width,var_489);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_489,var_39.width,var_489);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_39 != null)
            {
               if(var_39.width == param2 && var_39.height == param3 && Vector3d.isEqual(var_733,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_489,param6,param7);
                     return param1;
                  }
                  return var_39;
               }
