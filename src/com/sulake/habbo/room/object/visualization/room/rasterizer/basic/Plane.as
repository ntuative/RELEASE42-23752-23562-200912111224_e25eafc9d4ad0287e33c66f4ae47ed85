package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_603:PlaneVisualization = null;
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_603 = var_363.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_603 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_363 != null)
         {
            ...
            {
               _loc1_ = var_363.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
