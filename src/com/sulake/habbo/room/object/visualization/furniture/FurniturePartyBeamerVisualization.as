package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_750:int = 15;
      
      private static const const_1062:int = 2;
      
      private static const const_339:int = 2;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_978[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_976[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_978 = new Array();
         var_978.push(Math.random() * _loc2_ * 1.5);
         var_978.push(Math.random() * _loc2_ * 1.5);
         var_975 = new Array();
         var_975.push(1);
         var_975.push(-1);
         var_977 = new Array();
         var_977.push(const_1062);
         var_977.push(const_1061);
         var_976 = new Array();
         var_976.push(getRandomAmplitudeFactor());
         var_976.push(getRandomAmplitudeFactor());
      }
