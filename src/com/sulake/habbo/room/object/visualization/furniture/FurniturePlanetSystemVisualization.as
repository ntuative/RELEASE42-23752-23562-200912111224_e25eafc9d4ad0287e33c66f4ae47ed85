package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_873);
      ...
      {
         if(param1 < var_531.length)
         {
            return var_531[param1].y;
         }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_219 != null)
         {
            ...
            {
               _loc2_ = var_219[_loc3_];
               _loc2_.update(var_531,var_1876,param1);
               _loc3_++;
            }
