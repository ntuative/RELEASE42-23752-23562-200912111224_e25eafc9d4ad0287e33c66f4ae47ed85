   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_362:
                  _loc8_ = "null";
                  ...
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_566:
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_894,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_957,int(_loc5_.bgOnly));
            var_1079 = _color;
            var_1326 = var_1203;
            var_899 = _loc11_;
            var_1328 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_810,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_681,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1221,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1147,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1328,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_138 || _loc13_ == RoomPlaneData.const_233)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor() : void
      {
         ...
         if(var_726)
         {
            ...
            {
               _loc6_ = var_1079 >> 16 & 255;
               _loc7_ = var_1079 >> 8 & 255;
               _loc8_ = var_1079 & 255;
               _loc9_ = var_899 >> 16 & 255;
               _loc10_ = var_899 >> 8 & 255;
               _loc11_ = var_899 & 255;
               _loc12_ = (_loc1_ - var_726) / var_1327;
               _loc6_ += (_loc9_ - _loc6_) * _loc12_;
               _loc7_ += (_loc10_ - _loc7_) * _loc12_;
               _loc8_ += (_loc11_ - _loc8_) * _loc12_;
               _loc2_ = (_loc6_ << 16) + (_loc7_ << 8) + _loc8_;
               _loc3_ = var_1326 + (var_1328 - var_1326) * _loc12_;
               _color = _loc2_;
               var_1203 = _loc3_;
            }
            ...
            _loc5_.setNumber(RoomObjectVariableEnum.const_681,_loc2_);
         }
      }
   }
}
