package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_705:Number = 64;
      ...
      private var var_2251:Number = -500;
      ...
      {
         if(var_401 != param1 * var_1469)
         {
            var_401 = param1 * var_1469;
            ++var_84;
         }
      }
      ...
      {
         if(var_402 != param1 * var_1468)
         {
            var_402 = param1 * var_1468;
            ++var_84;
         }
      }
      ...
      {
         if(var_403 != param1 * var_1467)
         {
            var_403 = param1 * var_1467;
            ++var_84;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_999.assign(_loc22_);
         }
         else
         {
            var_999.assign(_loc17_);
         }
         ++var_84;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_403;
         _loc2_.z *= var_401;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_999);
         if(_loc3_ < var_2251 || _loc3_ > var_2252)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_403;
            _loc2_.z *= var_401;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_999);
         }
      ...
      {
         return new Vector3d(0 * var_402,0 * var_403,0 * var_401);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_402,0 * var_403,0 * var_401);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_89;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_402,param2.y * var_403,param2.z * var_401);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_402,param3.y * var_403,param3.z * var_401);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_402,param4.y * var_403,param4.z * var_401);
